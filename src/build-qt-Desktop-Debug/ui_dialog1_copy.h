/********************************************************************************
** Form generated from reading UI file 'dialog1_copy.ui'
**
...
#ifndef UI_DIALOG1_COPY_H
#define UI_DIALOG1_COPY_H
...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        radioButton->setGeometry(QRect(110, 370, 91, 22));
        radioButton->setFont(font2);
        radioButton_2 = new QRadioButton(Dialog);
        radioButton_2->setObjectName(QStringLiteral("radioButton_2"));
        radioButton_2->setGeometry(QRect(210, 370, 91, 22));
    ...
    {
        Dialog->setWindowTitle(QApplication::translate("Dialog", "Sign Up", 0));
